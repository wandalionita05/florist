...
import 'package:florist/models/dto/categorie.dart';
import 'package:florist/models/dto/product.dart';
import 'package:florist/utils/myStates.dart';
import 'package:florist/utils/dimensions.dart';
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                  shape: BoxShape.circle,
                  color: Get.theme.cardColor.withValues(alpha: 0.05)),
              child: ClipRRect(
